...
public class Graphics {
    ...
    public static void mainScreen() throws InterruptedException {
        ...
        System.out.println("\n\nTTTTTTTTTTTTTTTTTTTTT IIIIIIIIIIIIIIIIII CCCCCCCCCCCCCCC");
        ...
        System.out.println("TTTTTTTTTTTTTTTTTTTTT       AAAAA        CCCCCCCCCCCCCCC");
        System.out.println("       TTTTTT              AAAAAAA       CCCC");
        System.out.println("       TTTTTT             AAAAAAAAA      CCCC");
        System.out.println("       TTTTTT             A       A      CCCC");
        System.out.println("       TTTTTT            A         A     CCCC");
        System.out.println("       TTTTTT            AAAAAAAAAAA     CCCC");
        System.out.println("       TTTTTT           AAAAAAAAAAAAA    CCCC");
        System.out.println("       TTTTTT          A             A   CCCC");
        System.out.println("       TTTTTT          A             A   CCCC");
